  ...
  return (
    <div className="flex flex-wrap items-center justify-center gap-3 px-4 sm:gap-4">
      {featured.map((t) => (
        <div
          key={t.name}
          className="flex w-full max-w-[280px] items-center gap-3 rounded-full border border-white/10 bg-[#12101c]/85 px-4 py-2.5 shadow-lg backdrop-blur-md sm:w-auto sm:max-w-[300px]"
        >
